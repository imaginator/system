...
if [[ $(echo "$room" | grep -LE 'Kitchen|Lounge|Study|HallwayLarge|BathMain|BathGuest|Bedroom1|Bedroom2|Bedroom3') ]]; then 
...
adb shell dumpsys deviceidle whitelist +de.vier_bier.habpanelviewer # disable battery optimistaion
...
adb shell mkdir -m 777 -p /data/data/de.vier_bier.habpanelviewer/shared_prefs
...
adb shell chmod 777 /data/data/de.vier_bier.habpanelviewer/shared_prefs/*
